...
?>
		...
		// output data of each row
		  ...
		  ?>	
                ...
                <p class="amount">Amount : <i class="fas fa-dollar-sign"></i><input id="amountToBeSent" type="text" required></p>           
                <button class="send-button" style="padding-top:10px ;" onclick="validationOnSend()"><span class="send-button-span">Send </span></button> 
                <button class="back-button" style="padding-top:10px ;" onclick="window.history.back()"><span class="back-button-span"> Back</span></button>      
        </div>
    </section>
